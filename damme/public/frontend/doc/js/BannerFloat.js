$(document).ready(function(){
    ...
    } else
    {
        ...
        bFLeft.attr("style", "float: left; position: fixed; top: 80px; right: " + right_Positiion + "px;");
        bFRight.attr("style", "float: right; position: fixed; top: 80px; left: " + left_Positiion + "px;");
