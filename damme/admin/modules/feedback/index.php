<?php
    ...
    $sql = "SELECT feedback.note, users.name, product.thunbar, feedback.sosao, feedback.created_at, feedback.id FROM feedback 
            INNER JOIN product on product.id = feedback.product_id 
            INNER JOIN users on users.id = feedback.users_id";
    $admin = $db->fetchJone('feedback',$sql,$p,10,true);
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
    			...
    			<li class="active">
        			<i class="fa fa-file"></i> Đánh giá sản phẩm
                </li>
			</ol>
