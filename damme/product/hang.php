...
<?php
    ...
    $sql = " SELECT * FROM product WHERE hangxe_id = $id ";
...
<div class="bg-1" style="background-color: #ffffff;">
  <div class="container">
    <div class="row">
      <h3 class="text-center" style="font-size: 28px;letter-spacing: 1px; color: red;margin-top: 50px;"> HÃNG XE <?php echo $EditCategory['name'] ?> </h3>
                ...
                <div class="container">
                    <div class="col-md-3  fixside">
                        <div class="box-left box-menu">
                            <h3 class="box-title" style="margin-top: 0px;margin-bottom: 0px;"><i class="fa fa-list"></i>  Danh mục hãng </h3>
                            <ul>
                                <?php foreach($category as $item) :?>
                                    <li><a href="hang.php?id=<?php echo $item['id'] ?>" style="font-size: 11pt"><?php echo $item['name'] ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="box-left box-menu">
                    ...
                    <div class="col-md-9 bor" style="padding-bottom: 15px;">
                        <section class="box-main1">
                            <h3 class="title-main"  style="text-align: center;margin-top: -8px;" ><a href="" style="font-size: 16pt;"><?php echo $EditCategory['name'] ?></a> </h3>
