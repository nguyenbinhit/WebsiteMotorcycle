...
<?php
    ...
    $sql = " SELECT * FROM product WHERE theloai_id = $id ";
...
<div class="bg-1" style="background-color: #ffffff;">
  <div class="container">
    <div class="row">
      <h3 class="text-center" style="font-size: 28px;letter-spacing: 1px; color: red;margin-top: 50px;"> <?php echo $EditCategory['name'] ?> </h3>
                ...
                <div class="container">
                    <div class="col-md-3  fixside">
                        <div class="box-left box-menu">
                            <h3 class="box-title" style="margin-top: 0px;margin-bottom: 0px;"><i class="fa fa-list"></i>  Thể loại xe </h3>
                            <ul>
                                <?php foreach($theloai as $item) :?>
                                    <li><a href="loai.php?id=<?php echo $item['id'] ?>" style="font-size: 11pt"><?php echo $item['name'] ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="box-left box-menu">
